...
│   │   └── system_camera/     # calibrate_view: interactive re-derive of deskewed 5:3 screen_roi + circle-based arc bands + red HSV band -> system_camera_config.yaml
