...
def test_save_hand_poses_round_trip(tmp_path):
    from arm101_hand.config import HandPose, HandPoseConfig, load_hand_poses, save_hand_poses

    cfg = HandPoseConfig(poses={"grip": HandPose(positions=[1, 2, 3, 4, 5, 6, 7, 8])})
